...
public class OrdemInversa {
    public static void main(String[] args) {
       ...
       /*Quando temos um conjunto de elementos, como um vetor (ou array),
        podemos usar a propriedade length para descobrir
         quantos elementos existem nesse conjunto.
       
       Por exemplo, se tivermos um vetor com 6 números inteiros, 
       podemos usar vetor.length para descobrir que há 6 elementos nesse vetor. 
       O resultado de vetor.length seria 6.*/
        ...
        while (count >= 0) { //enquanto o contador tiver o valor maior ou igual 0
            ...
            /*imprima o valor do elemento do vetor na posição 
            indicada pelo contador.*/
