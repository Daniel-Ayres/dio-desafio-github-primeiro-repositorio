...
public class NumerosAleatorios {
    public static void main(String[] args) {
        ...
        Random random = new Random(); //classe para gerar números aleatórios para colocar dentro da variavel numero
        ...
        System.out.print("Numeros: "); //IMPRIME OS NUMEROS SEM OS SEUS SUCESSORES 
        ...
        System.out.print("Sucessores: "); //IMPRIME OS SUCESSORES DOS NUMEROS ANTERIORES 
